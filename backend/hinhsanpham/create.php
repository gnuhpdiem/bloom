...
<body>
    ...
    <?php 
        ...
        //var_dump($danhsachselectsanpham);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h1 style="display: block;">Thêm hình sản phẩm</h1>
            ...
            <?php 
                if (isset($_POST['btnLuu'])) {
                    ...
                    if (!empty($_FILES['hsp_tentaptin']['name'])){
                        ...
                        $sqlinserthinh = "INSERT INTO hinhsanpham
                                            (hsp_tentaptin, sp_ma)
                                            VALUES ('$newfilename', $sp_ma);";

                        if(mysqli_query($conn, $sqlinserthinh)) {
                            $_SESSION['status'] = 'Đã thêm một hình sản phẩm!';
