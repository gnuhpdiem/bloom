...
<body>
    ...
    <?php 
        ...
        $sql = "SELECT hsp.hsp_ma, hsp.hsp_tentaptin, sp.sp_ten FROM hinhsanpham AS hsp
                JOIN sanpham AS sp ON hsp.sp_ma = sp.sp_ma;";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php endif; ?>
                <h1 style="display: block;">Danh sách hình sản phẩm</h1>

                <a href="create.php" class="btn btn-outline-primary mb-3 align-baseline"><i class="fa fa-plus" aria-hidden="true"></i> Thêm hình sản phẩm</a>
                ...
                <table id="danhsach" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php foreach($danhsachhinhsanpham as $hsp): ?>
                            <tr>
                                <td><?= $hsp['hsp_ma']?></td>
                                <td><img src="/bloom/assets/uploads/<?= $hsp['hsp_tentaptin']?>" style="width: 200px;"></td>
                                <td><?= $hsp['sp_ten']?></td>
                                <td><a href="edit.php?hsp_ma=<?= $hsp['hsp_ma']?>" class="btn btn-outline-primary mr-2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
                                <a href="#" class="btn btn-outline-danger btnDelete" data-hsp_ma="<?= $hsp['hsp_ma']?>"><i class="fa fa-trash-o" aria-hidden="true"></i> Xóa</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
